...
export default function Cho({ navigation, route }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonGroup}>
        <TouchableOpacity style={styles.actionButton} onPress={() => navigation.navigate("HealthLit", { user })}>
          <Image source={require('./assets/cal.png')} style={styles.icon} />
          <Text style={styles.actionText}>Health Literacy Portal</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.actionButton}
          onPress={() => navigation.navigate("DocChoEmer", { user })}>
